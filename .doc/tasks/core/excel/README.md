...
- [EXCEL-007 OpenXml compatibility surface isolation](EXCEL-007-openxml-compatibility-surface-isolation.md) — open, the remaining `P0`
- [EXCEL-010 God-class decomposition (Worksheet and Spreadsheet)](EXCEL-010-god-class-decomposition.md)
  — Tier 1 delivered 2026-07-27; Tier 2 (breaking) open
